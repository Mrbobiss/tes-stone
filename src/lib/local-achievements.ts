...
export const achievementDefinitions: AchievementDefinition[] = [
  {
    ...
    title: "Premier roast",
    emoji: "🎬",
    description: "Tu as lancé ton tout premier verdict local.",
  ...
  },
  {
    ...
    emoji: "🪩",
    description: "Tu as testé plusieurs modes pour re-skinner ton roast.",
    hint: "Essaie 4 modes différents.",
  ...
  },
  {
    ...
    emoji: "🏁",
    description: "Tu as cumulé 10 verdicts dans l’historique local.",
